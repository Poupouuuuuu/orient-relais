    ...
    return (
        <Sheet open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
            ...
            <SheetContent className="w-[380px] sm:w-[480px] flex flex-col p-0">
                ...
                <div className="px-6 py-4 bg-stone-50 border-y border-stone-100">
                    <div className="flex justify-between text-sm mb-2">
                        {remainingForFreeShipping > 0 ? (
                            <span className="text-stone-700">Plus que <strong>{remainingForFreeShipping.toFixed(2)}€</strong> pour la livraison offerte !</span>
                        ) : (
                            <span className="text-green-700 font-medium flex items-center gap-1">✨ Livraison offerte débloquée !</span>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col gap-6 py-6">
                        ...
                        {items.length === 0 && (
                            <div className="text-center py-12 text-stone-500">
                                ...
                                <SheetClose asChild>
                                    <Button variant="link" className="mt-4 block mx-auto">
                ...
                {/* Footer Actions */}
                {items.length > 0 && (
                    <div className="p-6 border-t border-stone-100 bg-white space-y-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                        ...
                        <SheetClose asChild>
                            <Button asChild className="w-full h-12 text-base font-bold bg-primary hover:bg-orange-600">
                                <Link href="/checkout">
